...
<section class="about">
   ...
   <div class="row">
      ...
      <div class="content">
         ...
         <p>Hey There ! I'm Kumaraguru. A Student of BE in Computer Science Engineering Department from Sri Sairam Institute Of Technology . I love designing websites and exploring new things. Learning new things is my hobby.</p>
...
<section class="reviews">
   ...
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
         ...
         <p>Guru is great if you choose good sellers . A variety of required item available . Customers can return and refund full amount within 7 days easily . Guru is boosting eCommerce business in Kathmandu.It provides great opportunity to sale items online with ease.</p>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
      ...
      <div class="swiper-slide slide">
         ...
         <p>Using Guru for online shopping from almost 3 years. Outstanding experience with them. Game vouchers and pick up point as delivery with 0 shipping charges are super saving services.</p>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
      ...
      <div class="swiper-slide slide">
         ...
         <p>Guru is cool! I have ordered hundreds of products from it and never got any scam. It delivers products in time with out delay. Packaging of products are strong and delivery rates are too low. Just amazing Website will keep shopping from Guru.</p>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
